...
std::string HelpMessageCli()
{
    ...
    strUsage += "\n" + _("SSL options: (see the GongYiCoin Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  gongyicoin-cli [options] <command> [params]  " + _("Send command to GongYiCoin Core") + "\n" +
                  "  gongyicoin-cli [options] help                " + _("List commands") + "\n" +
                  "  gongyicoin-cli [options] help <command>      " + _("Get help for a command") + "\n";

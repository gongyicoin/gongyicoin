...
//            cout<<genesis.print()<<endl;
       ...
       // assert(genesis.hashMerkleRoot == uint256("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
        ...
        vSeeds.push_back(CDNSSeedData("node0", "139.129.13.66"));
        vSeeds.push_back(CDNSSeedData("node1", "121.42.12.254"));
        vSeeds.push_back(CDNSSeedData("node2", "115.28.209.92"));




/*
        vSeeds.push_back(CDNSSeedData("gongyicointools.com", "dnsseed.gongyicointools.com"));
        vSeeds.push_back(CDNSSeedData("gongyicoinpool.org", "dnsseed.gongyicoinpool.org"));

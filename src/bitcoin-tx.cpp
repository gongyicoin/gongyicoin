...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("GongYiCoin Core gongyicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gongyicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gongyicoin transaction") + "\n" +
              "  gongyicoin-tx [options] -create [commands]   " + _("Create hex-encoded gongyicoin transaction") + "\n" +
              "\n";

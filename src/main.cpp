...
#if defined(NDEBUG)
# error "GongYiCoin cannot be compiled without assertions."
#endif
...
*/
    ...
    if(         nHeight <  525600)   nSubsidy = 38.052 * COIN;
    else if(    nHeight < 1051200)   nSubsidy = 19.026 * COIN;
    else if(    nHeight < 1576800)   nSubsidy =  9.513 * COIN;
    else if(    nHeight < 2102400)   nSubsidy =  9.513 * COIN;
    else if(    nHeight < 2628000)   nSubsidy =  3.805 * COIN;
...
void ThreadScriptCheck() {
    RenameThread("gongyicoin-scriptch");
...
/*
    // Check proof of work# tmc
    if( (!Params().SkipProofOfWorkCheck()) && ( !CheckProofOfWork(hash, block.nBits)) ) 
    {   
...
*/
    ...
    // GongYiCoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // GongYiCoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)

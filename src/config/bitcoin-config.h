...
#define PACKAGE_BUGREPORT "info@gongyicoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GongYiCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GongYiCoin Core 0.10.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gongyicoin"
